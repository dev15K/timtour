        ...
        <form method="post" action="{{ route('admin.items.store') }}">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="ma_khach_hang" name="ma_khach_hang" value="{{ old('ma_khach_hang', $item->ma_khach_hang ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="ten_khach_hang">Tên khách hàng</label>
                    <input type="text" class="form-control" id="ten_khach_hang" name="ten_khach_hang" value="{{ old('ten_khach_hang', $item->ten_khach_hang ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="so_dien_thoai" name="so_dien_thoai" value="{{ old('so_dien_thoai', $item->so_dien_thoai ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="dia_chi">Địa chỉ</label>
                    <input type="text" class="form-control" id="dia_chi" name="dia_chi" value="{{ old('dia_chi', $item->dia_chi ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="mst" name="mst" value="{{ old('mst', $item->mst ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="nha_cung_cap" name="nha_cung_cap" value="{{ old('nha_cung_cap', $item->nha_cung_cap ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="tong_tien">Tổng tiền</label>
                    <input type="text" class="form-control onlyNumber" id="tong_tien" name="tong_tien" value="{{ old('tong_tien', $item->tong_tien ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="dich_vu" name="dich_vu" value="{{ old('dich_vu', $item->dich_vu ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="loai_dich_vu">Loại dịch vụ</label>
                    <input type="text" class="form-control" id="loai_dich_vu" name="loai_dich_vu" value="{{ old('loai_dich_vu', $item->loai_dich_vu ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="loai_tien" name="loai_tien" value="{{ old('loai_tien', $item->loai_tien ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="ti_gia">Tỉ giá</label>
                    <input type="text" class="form-control onlyNumber" id="ti_gia" name="ti_gia" value="{{ old('ti_gia', $item->ti_gia ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control onlyNumber" id="quy_doi" name="quy_doi" value="{{ old('quy_doi', $item->quy_doi ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="vat">VAT</label>
                    <input type="text" class="form-control onlyNumber" id="vat" name="vat" value="{{ old('vat', $item->vat ?? '') }}">
                </div>
            </div>
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="nhan_vien" name="nhan_vien" value="{{ old('nhan_vien', $item->nhan_vien ?? '') }}">
                </div>
                <div class="form-group col-md-6">
                    <label for="phai_tra">Phải trả</label>
                    <input type="text" class="form-control onlyNumber" id="phai_tra" name="phai_tra" value="{{ old('phai_tra', $item->phai_tra ?? '') }}">
                </div>
            </div>
